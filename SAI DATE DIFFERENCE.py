...
##########################################for date difference ##########################################
    ...
    leble_12 = Label(window, font=("Areal", 16, "bold"), text="               ").place(x=480, y=120)
    leble_13 = Label(window, font=("Areal", 16, "bold"), text=result).place(x=480, y=120)
...
############################################ for last day of month and equal date diff######################
    ...
    addyear58 = date(tt.year+58, tt.month, tt.day)
    ...
    finaldate58 = datetime.strptime(str(t_d)+str(t_m)+str(t_y),'%d%m%Y').date()
    ...
    finaldate60 = datetime.strptime(str(t_d)+str(t_m)+str(t_y),'%d%m%Y').date()
    ...
    lebleyearT = Label(window, font=("Areal", 16, "bold"), text="        ").place(x=220, y=160)  # for clear screen
    leblemontT = Label(window, font=("Areal", 16, "bold"), text="    ").place(x=360, y=160)	# for clear screen
    lebledayT  = Label(window, font=("Areal", 16, "bold"), text="    ").place(x=490, y=160)	# for clear screen  

    
    
    lebleyear = Label(window,font=("Areal",16,"bold"),width=4,text="{0:>4}".format(years),anchor=E).place(x=220, y=160)   # for year output    
    leblemont = Label(window,font=("Areal",16,"bold"),width=2,text="{0:>2}".format(months),anchor=E).place(x=355, y=160)	# for month output
    lebleday  = Label(window,font=("Areal",16,"bold"),width=2,text="{0:>2}".format(days),anchor=E).place(x=485, y=160)  	# for day output 
